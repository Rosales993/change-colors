...
changeToWhiteButton.addEventListener('click', () => {
  ...
  updateColorInfo('Blanco');
});

// Selecciona el elemento donde se mostrará la información del color
const colorInfoElement = document.getElementById('colorInfo');

// Función para obtener un color aleatorio y actualizar la información
function getRandomColor() {
  ...
  colorInfoElement.textContent = `El color actual es: ${color}`;
  return color;
}

// Función para actualizar la información del color
